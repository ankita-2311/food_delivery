...
df_data = pd.read_csv(r"C:\Users\KIIT\Desktop\food_delivery_dashboard\data\zomato.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"C:\Users\KIIT\Desktop\food_delivery_dashboard\data\Country-Code.xlsx")
print(df_country)
...
#downlaod data
#df.to_csv(r"C:\Users\KIIT\Desktop\food_delivery_dashboard\data\zomato.csv")
print(df.to_string)
